...
::grpc::Status Guide::Stub::GetNextStep(::grpc::ClientContext* context, const ::CarState& request, ::Step* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetNextStep_, context, request, response);
}

void Guide::Stub::experimental_async::GetNextStep(::grpc::ClientContext* context, const ::CarState* request, ::Step* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetNextStep_, context, request, response, std::move(f));
}

void Guide::Stub::experimental_async::GetNextStep(::grpc::ClientContext* context, const ::CarState* request, ::Step* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::Step>* Guide::Stub::PrepareAsyncGetNextStepRaw(::grpc::ClientContext* context, const ::CarState& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::Step>* Guide::Stub::AsyncGetNextStepRaw(::grpc::ClientContext* context, const ::CarState& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
Guide::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< Guide::Service, ::CarState, ::Step>(
          [](Guide::Service* service,
...
::grpc::Status Guide::Service::GetNextStep(::grpc::ServerContext* context, const ::CarState* request, ::Step* response) {
  (void) context;
  (void) request;
  (void) response;
